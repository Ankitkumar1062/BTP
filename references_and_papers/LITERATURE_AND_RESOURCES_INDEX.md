# Reference Papers & Literature Index

This directory contains the foundational literature, academic papers, and technical resources studied and synthesized for the **Tsetlin Machine to MLIR & CPOG Hardware Reuse** project.

---

## 📚 Collected Research Papers

### 1. MATADOR: Automated System-on-Chip Tsetlin Machine Design Generation for Edge Applications
- **File**: [`MATADOR_2024_DATE_Shafik.pdf`](./MATADOR_2024_DATE_Shafik.pdf)
- **Authors**: Rishad Shafik, Alex Yakovlev, Gang Mao, Sidharth Maheshwari, Tousif Rahman (*Newcastle University / nclaes*)
- **Venue**: IEEE / Design, Automation & Test in Europe (DATE 2024)
- **Significance**: Explores the use of **MLIR & CIRCT** for automated compilation and hardware generation of Tsetlin Machines ($13.4\times$ speedup, $7\times$ resource efficiency).
...
- **Significance**: Demonstrates event-driven and graph-modeled asynchronous hardware logic for Tsetlin Machine inference.
...
- **Significance**: Your accepted ISTM 2026 conference paper on compressed recurrent feedback interfaces.
